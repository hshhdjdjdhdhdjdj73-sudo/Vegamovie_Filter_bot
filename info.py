...
API_ID = int(environ.get('API_ID', '25919482'))
API_HASH = environ.get('API_HASH', '4804decd3c1edbc035893f3e1237cd85)
BOT_TOKEN = environ.get('BOT_TOKEN', '')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7617005461').split()]
USERNAME = environ.get('USERNAME', "https://t.me/luximovies1") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002920700042'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/+snaVRrln_oNmNTY1')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003102011841').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://neelamrana8128:neelamrana8128@cluster0.eyvqcaz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002920700042'))  # set shortner log channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002084819782')) # The movie you upload in it will be deleted from the bot.
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002920700042'))
auth_channel = environ.get('AUTH_CHANNEL', '-1003154439433')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1003148590921'))
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003154439433')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/luximoviessupport') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
